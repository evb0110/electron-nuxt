export default {
    ...
    'annotations': {
        ...
        'noNotesHint': 'Adicione uma nota com a ferramenta de nota adesiva ou procure outro autor, pagina ou palavra-chave.',
    ...
    'searchResults': {
        ...
        'page': 'Página {page}',
        'pageWithCount': 'Página {page} ({count} correspondência) | Página {page} ({count} correspondências)',
