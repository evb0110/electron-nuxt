...
export default {
    ...
    'emptyState': {
        ...
        'tools': 'Hulpmiddelen',
        'ocrSearch': 'OCR en zoeken',
        'compareFiles': 'Bestanden vergelijken',
        'batch': 'Batch',
        'tipTitle': 'Tip',
        'tipBody': 'Sleep bestanden hierheen om ze snel te openen.',
        'dropTitle': 'Sleep bestanden hierheen',
        'dropSubtitle': 'PDF, DjVu, afbeeldingen en meer',
        'or': 'of',
