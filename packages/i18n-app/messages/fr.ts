export default {
    ...
    'annotations': {
        ...
        'moreNotes': '+{count} note supplémentaire | +{count} notes supplémentaires',
        'openPopUpNote': 'Ouvrir la note contextuelle',
        'openPopUpNoteCount': 'Ouvrir la note contextuelle ({count} note) | Ouvrir la note contextuelle ({count} notes)',
    },
    ...
    'searchResults': {
        ...
        'typeMinChars': 'Saisissez au moins {count} caractères',
    ...
    'bookmarks': {
        ...
        'applyStyleToCount': 'Appliquer le style à {count} signet | Appliquer le style à {count} signets',
    ...
    'pageOps': {
        ...
        'pagesSelected': '{count} page sélectionnée | {count} pages sélectionnées',
