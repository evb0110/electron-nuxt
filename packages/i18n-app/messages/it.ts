...
export default {
    ...
    'webHome': {
        ...
        'title': 'Apri, cerca, annota e riorganizza i PDF direttamente nel browser.',
        'description': 'L’app web ora ha un proprio punto di ingresso. Parti da una home pensata per il browser, apri un file e passa allo stesso spazio di lavoro condiviso usato dall’app desktop.',
        'primaryAction': 'Apri file',
        'secondaryAction': 'Apri spazio di lavoro',
        'caption': 'Nel browser sono supportati PDF e formati immagine comuni. OCR e DjVu per ora restano solo su desktop.',
        ...
        'emptyRecentDescription': 'Apri un PDF o un’immagine per mantenerlo disponibile tra i recenti e nell’archivio del browser.',
        ...
        'features': {
            ...
            'organize': 'Riordina, ruota, ritaglia, estrai e salva le pagine modificate.',
            'noOcr': 'OCR non è disponibile intenzionalmente nella versione browser.',
            'noDjvu': 'DjVu resta per ora fuori dalla build browser.',
        },
        'cards': {
            ...
            'saveDescription': 'Usa l’archivio del browser e i flussi di salvataggio senza dipendere dalle API di Electron.',
        },
    },
    'webWorkspace': {
    ...
    'errors': {
        ...
        'djvu': {
            ...
            'unsupportedBrowser': 'DjVu non è disponibile nella versione web.',
        },
        'workspace': {
