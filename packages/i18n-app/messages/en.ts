...
export default {
    ...
    'scanCleanup': {
        ...
        'pages': {
            ...
            'collapse': 'Collapse page list',
            'expand': 'Expand page list',
            'overrideFor': 'Layout override for page {page}',
            'rotateFor': 'Rotate page {page}; current rotation {rotation} degrees',
            'excludeFor': 'Exclude page {page} from output',
            'classification': {
                'single': 'Single',
                'spread': 'Spread',
                'offcut': 'Offcut',
        ...
        'continuesHint': 'You can close this — cleanup continues',
