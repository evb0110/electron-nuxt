...
export default {
    ...
    'settings': {
        ...
        'optimizePdfOnSaveAsDescription': 'Runs a lossless qpdf rewrite on Save As and keeps it only when the PDF stays valid and smaller.',
