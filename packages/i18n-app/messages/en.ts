...
export default {
    ...
    'dialogs': {
        ...
        'agentMcp': {
            'enableTitle': 'Enable Codex MCP',
            'enableMessage': 'Allow EVB Viewer to add its local MCP server to Codex settings?',
            'disableTitle': 'Disable Codex MCP',
            'disableMessage': 'Remove EVB Viewer from Codex MCP settings?',
    ...
    'settings': {
        ...
        'agentMcp': 'External Codex MCP',
        'agentMcpDescription': 'Expose EVB Viewer tools to a separate Codex app or CLI on this computer.',
        'agentMcpEnable': 'Enable',
        'agentMcpDisable': 'Disable',
        'agentMcpRepair': 'Repair',
        'agentMcpRefresh': 'Refresh Codex MCP status',
        'agentMcpInstallCodex': 'Install Codex',
        'agentMcpInstallHint': 'Codex is not installed yet. Install it, then enable this setting again.',
        'agentMcpStatusReady': 'Ready for Codex',
        'agentMcpStatusReadyHint': 'Codex can discover and use EVB Viewer tools.',
        'agentMcpStatusDisabled': 'Disabled',
        'agentMcpStatusCodexMissing': 'Codex not found',
