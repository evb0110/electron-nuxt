...
export default {
    ...
    'scanCleanup': {
        ...
        'pages': {
            ...
            'rotateCurrent': 'Rotate page (currently {rotation}°)',
            ...
            'textAxisAria': 'Sideways text hint for page {page}',
            'outputModeFor': 'Output mode for page {page}',
            'outputModeAria': 'Output mode for page {page}: {hint}',
            ...
            'outputModeLosslessHint': 'Effective mode: {mode} — preserving original quality forces color.',
            ...
            'diagnostics': {
                'open': 'Show diagnostics for page {page}',
                'title': 'Page {page} diagnostics',
        ...
        'detectAll': {
            ...
            'rasterizingProgress': 'Rasterizing {completed} / {total}',
        ...
        'cancelingDetection': 'Canceling detection…',
        ...
        'runProgress': {
            ...
            'probing': 'Probing {completed} / {total}',
            'rasterizing': 'Rasterizing {completed} / {total}',
            'classifying': 'Classifying {completed} / {total}',
            'rendering': 'Rendering {completed} / {total}',
            'assembling': 'Assembling PDF…',
            'handoff': 'Opening result…',
            'detecting': 'Detecting {completed} / {total}',
        },
    ...
    'settings': {
        ...
        'performanceModeHigh': 'High — maximize throughput',
    },
    'updates': {
