...
export default {
    ...
    'scanCleanup': {
        ...
        'settings': {
            'tabsLabel': 'Settings scope',
            'document': 'Document',
            'selection': 'Selection ({count})',
            'selectionDisabled': 'Select one or more source pages to edit page overrides.',
            'applyTo': 'Apply to…',
            ...
            'enableMatchPageSize': 'Enable “Match page size” on the Document tab to use placement.',
            'applyScopes': {
                'allPages': 'All pages',
        ...
        'pages': {
            ...
            'resetConfirmBody': 'Every per-page layout, rotation, cutter, and inclusion change will be cleared.',
            'resetAction': 'Reset',
