...
export default {
    ...
    'scanCleanup': {
        ...
        'lossNotice': 'The new PDF is image-only. Vector text, annotations, forms, and attachments are not carried over. Run OCR on the result to make it searchable.',
        ...
        'details': 'Details',
        'cleanUp': 'Clean up',
        'runOcrAfterCleanup': 'Run OCR on result',
        'runningLabel': 'Scan cleanup running, {processed} of {total}',
        ...
        'completedAndOcrTitle': 'Scan cleanup complete — OCR started',
        ...
        'progress': 'Processed {processed} of {total} source pages',
