...
export default {
    ...
    'scanCleanup': {
        ...
        'settings': {
            ...
            'applyThisPageTo': 'Apply this page to…',
            'applyThisPageToHint': 'Switch to the This page scope to copy its settings to other pages.',
            ...
            'resetToAutomatic': 'Use automatic',
        ...
        'contentPreserved': 'Output preserves original page content —',
        'losslessNotice': 'Pages are split, cropped, and rotated by changing PDF page geometry. Original vector text, graphics, fonts, and images are retained without rasterization.',
        'losslessLimitNotice': 'Pixel cleanup filters are disabled. Interactive document-level features that do not belong to an output page may not be carried over.',
        'details': 'Details',
        'cleanUp': 'Clean up',
