...
fn map_region_semantic_output(output: region_rendering::RegionSemanticOutput) -> CleanupResult {
    ...
    let region_rendering::RegionSemanticMetadata {
        source_page_index,
        half,
        ...
        canvas_policy,
        canvas_overflow,
        matched_canvas_target_width,
        matched_canvas_target_height,
        matched_canvas_target_width_points,
        matched_canvas_target_height_points,
        matched_canvas_content_width,
        matched_canvas_content_height,
        matched_canvas_optical_placement,
        matched_canvas_optical_content_left,
        matched_canvas_optical_content_right,
        matched_canvas_intrinsic_overflow_left,
        matched_canvas_intrinsic_overflow_right,
        matched_canvas_intrinsic_overflow_top,
        fold_clip_left,
        fold_clip_right,
        pdf_image_placement,
        output_mode,
        bilevel_written,
        layered_written,
        layered_foreground_kind,
        layered_background_dpi,
        layered_foreground_dpi,
        trusted_mrc_background_preserved,
        trusted_selection_applied,
    ...
    CleanupResult {
        ...
        metadata: CleanupMetadata {
            ...
            cutter_x,
            split_geometry,
            split_seam: split_seam.map(|seam| crate::protocol::manifest_v3::SplitSeamPolyline {
                points: seam.points,
            }),
            source_region,
            content_box,
...
fn compose_mixed(
    ...
    final_composition::run(final_composition::Input {
        gray,
        raw_gray,
        color,
        binary,
