...
- Manual CI quality lanes run `validate`, release tests, coverage, native Rust tests, and landing checks on demand; nightly maintenance keeps the broader deterministic coverage running outside the local patch-cut path.
