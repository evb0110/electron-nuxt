...
- The release always builds and verifies both Microsoft Store AppX packages before promotion. API submission runs only when all three Partner Center secrets are configured. Without them, the submission step is a deliberate no-op, as it was for v0.1.426.
