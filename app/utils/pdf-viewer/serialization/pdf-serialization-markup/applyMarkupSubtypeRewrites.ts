...
import { normalizePdfTextMarkupQuadPoints } from '@app/utils/pdf-viewer/text-markup-visual-model/normalizePdfTextMarkupQuadPoints';
import type { TPdfTextMarkupRect } from '@app/utils/pdf-viewer/text-markup-visual-model/textMarkupVisualModelTypes';
