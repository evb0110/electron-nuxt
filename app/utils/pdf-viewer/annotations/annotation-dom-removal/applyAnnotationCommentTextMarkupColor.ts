...
import { recolorCanvasTextMarkupPixelsInRect } from '@app/utils/pdf-viewer/annotations/annotation-text-markup-canvas-pixels/recolorCanvasTextMarkupPixelsInRect';
