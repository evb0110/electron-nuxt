...
import { mergeMarkerRects } from '@app/utils/pdf-viewer/annotation-geometry/mergeMarkerRects';
import { normalizeMarkerRect } from '@app/utils/pdf-viewer/annotation-geometry/normalizeMarkerRect';
import type { IDetachedCommentCluster } from '@app/utils/pdf-viewer/annotations/annotation-marker-geometry/annotationMarkerGeometryTypes';
