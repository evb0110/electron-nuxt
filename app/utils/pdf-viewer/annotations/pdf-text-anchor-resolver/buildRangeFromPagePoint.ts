...
import { findClosestTextSpanInPage } from '@app/utils/pdf-viewer/annotations/pdf-text-anchor-resolver/findClosestTextSpanInPage';
import { resolveWordOffsets } from '@app/utils/pdf-viewer/annotations/pdf-text-anchor-resolver/resolveWordOffsets';
