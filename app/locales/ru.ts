export default {
    ...
    'errors': {
        ...
        'runtime': {
            ...
            'description': 'В приложении произошла неожиданная ошибка, и до перезагрузки оно может работать некорректно.',
            'startupTitle': 'Не удалось запустить приложение',
            'startupDescription': 'Приложение не смогло завершить запуск. Перезагрузите его и попробуйте снова.',
