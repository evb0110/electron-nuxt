...
import {
    recolorCanvasTextMarkupPixelsInRect,
    sampleCanvasTextMarkupColorAtPoint,
    sampleCanvasTextMarkupColorInRect,
} from '@app/composables/pdf/annotations/annotationTextMarkupCanvasPixels';

export const drawAnnotationCommentTextMarkupCanvasVisual = drawEditedTextMarkupCanvasVisual;
