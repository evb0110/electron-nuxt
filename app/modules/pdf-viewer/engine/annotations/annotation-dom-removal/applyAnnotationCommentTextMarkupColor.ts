import type { ITextMarkupCandidateContext } from '@app/modules/pdf-viewer/engine/annotations/annotation-dom-removal/textMarkupDomRemovalTypes';
import type {
...
function recolorMatchingHighlightVisuals(
    ...
    const candidates = collectMatchingTextMarkupVisuals(context, pageContainer, targetRects);
