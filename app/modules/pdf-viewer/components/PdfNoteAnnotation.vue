...
const noteStyle = computed(() => ({
    left: `${props.entity.position.left * 100}%`,
    top: `${props.entity.position.top * 100}%`,
    width: `${Math.max(props.entity.position.width, 0.018) * 100}%`,
    height: `${Math.max(props.entity.position.height, 0.018) * 100}%`,
