import type { IDocumentsFileCapability } from '@contracts/platform-api';
...
} from '@app/platform/browser-api/browser-pdf-validation';
import {
...
import { createCombinedPdfFromPaths } from '@app/platform/browser-api/browser-combine-service';
import {
    createBrowserWorkingCopyFromBytes,
    decryptBrowserWorkingCopy,
    openDocumentPaths,
} from '@app/platform/browser-api/browser-working-copy-service';
import {
    assertBrowserPathWithinFullReadBudget,
    saveWorkingBytesToSource,
} from '@app/platform/browser-api/browser-save-targets';
