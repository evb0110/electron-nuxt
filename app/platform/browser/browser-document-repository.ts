...
} from '@app/platform/browser/browser-document-types';
import {
    deleteRecord,
    loadAllRecords,
    loadRecord,
    persistRecord,
} from '@app/platform/browser/browser-document-idb';
import {
    createChunkKey,
    deleteChunkRecord,
    loadAllChunkKeys,
...
} from '@app/platform/browser/browser-document-chunks';
import {
    readFileHandleBytes,
    readFileHandleSize,
} from '@app/platform/browser/browser-file-handle-bridge';
import {
...
} from '@app/platform/browser/browser-recent-files-store';
