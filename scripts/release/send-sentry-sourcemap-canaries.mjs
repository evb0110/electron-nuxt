...
/** @typedef {{event: Parameters<typeof createEventEnvelope>[0], evidence: {bundle: string, eventId: string, expectedFunction: string | null, expectedLine: number, expectedSource: string, role: string}}} ICanaryEvent */
