...
const pythonResult = run('python3', [
    '-c',
    'import cv2, img2pdf, numpy, PIL; print(f"cv2={cv2.__version__} img2pdf={img2pdf.__version__} numpy={numpy.__version__} PIL={PIL.__version__}")',
]);
addCheck({
    detail: pythonResult.ok ? pythonResult.stdout : pythonResult.stderr || pythonResult.error,
    name: 'Python page-processor modules',
    remedy: 'On Ubuntu, install python3-numpy python3-opencv python3-pil python3-img2pdf.',
    required: true,
