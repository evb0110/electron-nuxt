    ...
    await page.waitForFunction((args: {
        ...
        for (const element of Array.from(document.querySelectorAll<HTMLElement>('*'))) {
            ...
            for (const candidate of [
                ...
                const workspace = candidate as {getToolbarSnapshot?: () => {
                    canUndo?: boolean;
                    canRedo?: boolean;
                };};
                ...
                return snapshot.canUndo === args.canUndo && snapshot.canRedo === args.canRedo;
            }
        }
        return false;
    }, { timeout: timeoutMs }, {
        canUndo: expectedState.canUndo,
        canRedo: expectedState.canRedo,
    });
}
...
describe('Electron E2E - Phase 3 (Undo/Redo + Persistence)', () => {
    it('undoes/redoes an annotation and persists it across app restart', async () => {
        ...
        try {
            ...
            await waitForToolbarActionState(primarySession.page, {
                canUndo: false,
                canRedo: true,
            });
