...
export const ASSISTANT_BOOKMARK_WORKFLOW = [
    ...
    'Read evb://document/{tabId}/toc and /bookmarks and inspect text coverage with document.inspect_text. Use the flat path list to preserve or extend existing TOC/bookmark nodes; treat existing destinations as hints, not proof.',
